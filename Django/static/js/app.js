 ...
 * Управление UI, состояниями загрузки и обработкой ошибок.
 */
...
const App = {
    ...
    /** Загрузка списка мастер-классов */
    async loadWorkshops() {
        this.setLoading(true);
        try {
    ...
    /** Отрисовка списка мастер-классов */
    ...
    /** Создание или обновление мастер-класса (админ) */
